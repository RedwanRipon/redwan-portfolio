...
export function ThemeToggle() {
  ...
  if (!theme) {
    return (
      <div
        aria-hidden
        className="pointer-events-none fixed bottom-24 right-6 z-50 h-11 w-11"
      />
    );
  }
